...
| Error messages with IPs/conn strings | Error sanitizer redacts IPs (`198.51.100.5` → `[redacted]`), connection URLs, and file paths from all error responses. 5xx returns `"internal server error"`. |
