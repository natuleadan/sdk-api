...
func (l *lazyCRUD) List(ctx *RestCtx, params ListParams) error { return l.init().List(ctx, params) }
func (l *lazyCRUD) Get(ctx *RestCtx, id string) error          { return l.init().Get(ctx, id) }
func (l *lazyCRUD) Create(ctx *RestCtx, body []byte) error     { return l.init().Create(ctx, body) }

func (l *lazyCRUD) Update(ctx *RestCtx, id string, body []byte) error {
	return l.init().Update(ctx, id, body)
}
func (l *lazyCRUD) Delete(ctx *RestCtx, id string) error { return l.init().Delete(ctx, id) }
